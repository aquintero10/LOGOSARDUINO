...
var timer_id;
  ...
  app.post('/derecha', function (req, res) {
    publish("get/derecha", "DERECHA", options);
...
app.post('/bderecha', function (req, res) {
  publish("get/derecha", "DERECHA", options);

  var movi = new ChatModel({_id:uuid.v1(),mov:"derecha",RegisterDate:moment().format("YYYY-MM-DD hh:mm:ss"),Duration:"00:00:01",place:"brazo mioelectrico"});
  ...
  res.send('movimiento derecha guardado');
});
